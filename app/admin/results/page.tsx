...
import { getCategories, getLevels, getResults } from "@/lib/queries";
...
export default async function ResultsPage({
  ...
  const [categories, levels, results] = await Promise.all([
    getCategories(),
    getLevels(),
    getResults(filters),
  ]);
  ...
  return (
    <Card>
      ...
      <form className="mt-6 grid gap-4 rounded-[28px] bg-surface-soft p-4 md:grid-cols-4">
